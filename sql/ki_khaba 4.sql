...
INSERT INTO `orders` (`order_id`, `user_id`, `order_item`, `price`, `quantity`, `total`) VALUES
(1, 19, 'drink', 3, 0, 0),
(2, 19, 'Food Platter 2', 400, 0, 0),
(3, 19, 'Food Platter 6', 400, 0, 0),
(4, 19, 'Food Platter 1,Beef Meal', 150, 0, 0);
