...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2023 at 06:05 PM
...
(1, 'sopnil', '$2y$10$Dfw9t56sC7ksQdEQkPPTru.8E2a4oxiKNCA.Adr24NugaCoZNHYRG');
...
(114, 'img_upload/12414290-01.jpg', 'coke', '1232323', 12, 12),
(115, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPcdplisnlZNsQSToOr8YQ6XhD6rajhGr5czrRxgE&s', 'drink', 'awsds', 3, 4);
...
CREATE TABLE `orders` (
  ...
  `order_item` varchar(235) NOT NULL,
...
INSERT INTO `orders` (`order_id`, `user_id`, `order_item`, `price`, `quantity`, `total`, `is_pending`, `order_time`) VALUES
(1, 19, 'Food Platter 1,Food Platter 2', '450,400', '1,1', 850, '1', '2023-04-18 00:00:00.000000'),
(2, 19, 'Beef Meal,Food Platter 1,Food Platter 2', '150,450,400', '1,1,1', 1000, '0', '2023-04-18 17:43:04.000000'),
(3, 19, 'Beef Meal,Food Platter 1,Food Platter 2', '150,450,400', '1,1,1', 1000, '0', '2023-04-18 13:44:06.000000'),
(7, 19, 'Food Platter 1', '450', '1', 450, '0', '2023-04-18 17:47:39.000000');
...
INSERT INTO `top_rated` (`id`, `image`, `title`, `description`, `price`, `off_percentage`) VALUES
(1, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTgC9R3FlYWRiDv8YSM4yEvBMyM6I6ddpdS3Q&usqp=CAU', 'Spicy Chicken S', 'A delicious sandwich with a spicy k', 178, 10),
(2, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTAgjq7W37aRL3ubW0pcpc5XJPOO1pHaVraYQ&usqp=CAU', 'Beef Burger', 'A classic burger with juicy beef pa', 148, 5),
(3, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSt5DmgkdZ_GNqT33wVJqy6g9KTkdzpHtYX6g&usqp=CAU', 'Veggie Wrap', 'A healthy and tasty wrap filled wit', 104, 15),
(4, 'https://takethemameal.com/files_images_v2/stam.jpg', 'Beef Meal', 'With pasta and Yard-long Bean', 150, 10),
(5, 'https://images.unsplash.com/photo-1676037150408-4b59a542fa7c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80', 'Food Platter 1', 'Moist, fluffy cake with chocolate f', 450, 10),
(6, 'https://images.pexels.com/photos/247685/pexels-photo-247685.png?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Food Platter 2', 'Delicious pastry with sweet or savo', 400, 10),
(7, 'https://images.pexels.com/photos/7287723/pexels-photo-7287723.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1', 'Food Platter 3', 'Rich, decadent dessert with chocola', 350, 10);
...
CREATE TABLE `users` (
  ...
  `user_password` varchar(135) NOT NULL,
...
(15, 'sda', 'asd', 'hola2@gmail.com', '$2y$10$Y1dVEyT1yLlZ4QUIHLFYWOeJvcl/', '475'),
(16, 'sds', 'ds', 'hola3@gmail.com', '$2y$10$lM8XJ3dcjkDxz5D56d344umJLtn.w1Wmm8AxTnbgdez9.SbvfZas6', '564646'),
(17, 'sdasd', 'sadasd', 'lol@gmail.com', '$2y$10$VZti7UX4uR/IGP/Vc1xZjufRGJ3xy04lusGumCnwpt6GXpcUzzJyS', '3523413'),
(18, 'dgd', 'gdfg', 'ji@gmail.com', '$2y$10$Ese7jm82RrZD9DFUMRrGl.8mZVaZ7Je49u5jQmK8nLMZOaavAyXO2', '54164'),
(19, 'rahim', 'sdasd', 'sop@gmail.com', '$2y$10$uHOtkO.bF1Jk.KcDigiTt.XiqQHRlgSyEb97QJvfVX9qxm3q1hloS', '05416416');
